...
void ViatorParameters::Params::initSliderParams()
{
    ...
    _sliderParams.push_back({ViatorParameters::sweetenerID, ViatorParameters::sweetenerName, 0.0, 100.0, 0.0, skew::kNoSkew, 0.0, type::kInt});
    ...
    // for attachments
    _pluginSliderParams.push_back({ViatorParameters::sweetenerID, ViatorParameters::sweetenerName, 0.0, 100.0, 0.0, skew::kNoSkew, 0.0, type::kInt});
